...
export default function createFirebaseInstance(firebase, configs, dispatch) {
   ...
   * available in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#update).
   ...
   * in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#updateWithMeta).
   * @param {string} path - Path to location on Firebase which to update
   * @param {object|string|boolean|number} value - Value to update to Firebase
   * @param {Function} onComplete - Function to run on complete (`not required`)
   * @returns {Promise} Containing reference snapshot
   ...
   * More info available in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#remove).
   ...
   * More info available in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#uniqueSet).
   * @param {string} path - Path to location on Firebase which to set
   * @param {object|string|boolean|number} value - Value to write to Firebase
   * @param {Function} onComplete - Function to run on complete (`not required`)
   * @returns {Promise} Containing reference snapshot
   ...
   * in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#uploadFile).
   * @param {string} path - Path to location on Firebase which to set
   ...
   * in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#uploadFiles).
   * @param {string} path - Path to location on Firebase which to set
   ...
   * in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#deleteFile).
   * @param {string} path - Path to location on Firebase which to set
   * @param {string} dbPath - Database path to place uploaded file metadata
   * @returns {Promise} Containing the File object
   */
   ...
   * More info available in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#watchEvent).
   ...
   * as expected. More info available in [the docs](https://react-redux-firebase.com/docs/api/props-firebase.html#unwatchevent).
   * @param {string} type - Type of watch event
